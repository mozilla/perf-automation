...
var Sentry = (function (exports) {
  ...
  class SyncPromise {
      constructor(executor) {
          ...
          /** JSDoc */
          this._resolve = (value) => {
              this._setResult("RESOLVED" /* RESOLVED */, value);
          };
          /** JSDoc */
          this._reject = (reason) => {
              this._setResult("REJECTED" /* REJECTED */, reason);
          };
          /** JSDoc */
          this._setResult = (state, value) => {
              if (this._state !== "PENDING" /* PENDING */) {
                  return;
              }
              if (isThenable(value)) {
          ...
          this._executeHandlers = () => {
              ...
              cachedHandlers.forEach(handler => {
                  ...
                  if (this._state === "RESOLVED" /* RESOLVED */) {
                      if (handler.onfulfilled) {
                          // eslint-disable-next-line @typescript-eslint/no-floating-promises
                          handler.onfulfilled(this._value);
                      }
                  }
                  if (this._state === "REJECTED" /* REJECTED */) {
