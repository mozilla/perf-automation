...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm_bullet.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm_bullet.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm_bullet.asm.js';
...
STATICTOP = STATIC_BASE + 464992;
  /* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_bullet_cpp() } }, { func: function() { __GLOBAL__sub_I_btQuickprof_cpp() } });
  

memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm_bullet.js.mem" : null;




var STATIC_BUMP = 464992;
...
Module['wasmTableSize'] = 880;

Module['wasmMaxTableSize'] = 880;
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "invoke_viiiifffffif": invoke_viiiifffffif, "invoke_vif": invoke_vif, "invoke_viifii": invoke_viifii, "invoke_viiiii": invoke_viiiii, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_iiiiiii": invoke_iiiiiii, "invoke_viiiif": invoke_viiiif, "invoke_ii": invoke_ii, "invoke_viifi": invoke_viifi, "invoke_viiif": invoke_viiif, "invoke_viffiii": invoke_viffiii, "invoke_iiiiiiiiii": invoke_iiiiiiiiii, "invoke_fiiiiiiiiiii": invoke_fiiiiiiiiiii, "invoke_fiifii": invoke_fiifii, "invoke_iiii": invoke_iiii, "invoke_fif": invoke_fif, "invoke_vifi": invoke_vifi, "invoke_viiiiii": invoke_viiiiii, "invoke_iiif": invoke_iiif, "invoke_fiii": invoke_fiii, "invoke_viiifii": invoke_viiifii, "invoke_fiiiiiiiiii": invoke_fiiiiiiiiii, "invoke_fiiiii": invoke_fiiiii, "invoke_iiiiiiiiiiii": invoke_iiiiiiiiiiii, "invoke_vifii": invoke_vifii, "invoke_fi": invoke_fi, "invoke_viiiiiiiiii": invoke_viiiiiiiiii, "invoke_iii": invoke_iii, "invoke_iifif": invoke_iifif, "invoke_viiiiffffiif": invoke_viiiiffffiif, "invoke_iiiii": invoke_iiiii, "invoke_viii": invoke_viii, "invoke_v": invoke_v, "invoke_viif": invoke_viif, "invoke_fiiifii": invoke_fiiifii, "invoke_viiii": invoke_viiii, "_pthread_cleanup_pop": _pthread_cleanup_pop, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___gxx_personality_v0": ___gxx_personality_v0, "___assert_fail": ___assert_fail, "__ZSt18uncaught_exceptionv": __ZSt18uncaught_exceptionv, "___setErrNo": ___setErrNo, "_llvm_pow_f32": _llvm_pow_f32, "___cxa_begin_catch": ___cxa_begin_catch, "_emscripten_memcpy_big": _emscripten_memcpy_big, "___resumeException": ___resumeException, "___cxa_find_matching_catch": ___cxa_find_matching_catch, "_pthread_getspecific": _pthread_getspecific, "_pthread_once": _pthread_once, "_pthread_key_create": _pthread_key_create, "_pthread_setspecific": _pthread_setspecific, "_abort": _abort, "_pthread_cleanup_push": _pthread_cleanup_push, "_gettimeofday": _gettimeofday, "___syscall140": ___syscall140, "___cxa_pure_virtual": ___cxa_pure_virtual, "___syscall146": ___syscall146, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
...
var __GLOBAL__sub_I_bullet_cpp = Module["__GLOBAL__sub_I_bullet_cpp"] = asm["__GLOBAL__sub_I_bullet_cpp"];
