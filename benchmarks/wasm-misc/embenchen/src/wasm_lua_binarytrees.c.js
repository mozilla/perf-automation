...
Module['FS_createDataFile']('/', 'binarytrees.lua', fileData0, true, true, false);
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasm_lua_binarytrees.c.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasm_lua_binarytrees.c.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasm_lua_binarytrees.c.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasm_lua_binarytrees.c.js.mem" : null;
...
Module['wasmTableSize'] = 298;

Module['wasmMaxTableSize'] = 298;
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "invoke_iiii": invoke_iiii, "invoke_vi": invoke_vi, "invoke_vii": invoke_vii, "invoke_ii": invoke_ii, "invoke_iiiii": invoke_iiiii, "invoke_iii": invoke_iii, "_pthread_cleanup_pop": _pthread_cleanup_pop, "___syscall221": ___syscall221, "_llvm_pow_f64": _llvm_pow_f64, "___syscall265": ___syscall265, "_signal": _signal, "___syscall63": ___syscall63, "_abort": _abort, "___syscall40": ___syscall40, "_pthread_cleanup_push": _pthread_cleanup_push, "_difftime": _difftime, "_system": _system, "___buildEnvironment": ___buildEnvironment, "_longjmp": _longjmp, "__addDays": __addDays, "_localtime_r": _localtime_r, "_tzset": _tzset, "___setErrNo": ___setErrNo, "___syscall330": ___syscall330, "_emscripten_memcpy_big": _emscripten_memcpy_big, "__exit": __exit, "_mktime": _mktime, "_strftime": _strftime, "_clock": _clock, "__arraySum": __arraySum, "_gmtime": _gmtime, "_getenv": _getenv, "___syscall33": ___syscall33, "___syscall54": ___syscall54, "___unlock": ___unlock, "__isLeapYear": __isLeapYear, "___syscall38": ___syscall38, "___syscall10": ___syscall10, "_gmtime_r": _gmtime_r, "___lock": ___lock, "___syscall6": ___syscall6, "___syscall5": ___syscall5, "_time": _time, "___syscall140": ___syscall140, "_localtime": _localtime, "_exit": _exit, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
